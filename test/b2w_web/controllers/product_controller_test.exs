defmodule B2wWeb.ProductControllerTest do
  use B2wWeb.ConnCase

  alias B2w.Accounts

  @create_attrs %{amount: 42, description: "some description", name: "some name", price: 120.5, sku: "some sku"}
  ...
  def fixture(:product) do
    {:ok, product} = Accounts.create_product(@create_attrs)
    product
  end
